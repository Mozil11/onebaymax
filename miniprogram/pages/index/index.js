        ...
        self.setData({
          postsShowSwiperList: self.data.postsShowSwiperList.concat(response.data.map(function (item) {
            if (!item.post_large_image) {
              item.post_large_image = "https://ozil.vip/images/html.jpg";
            }
            return item;
          })).slice(0,4),
          displaySwiper: "block"
      ...
      var idarry = [];
        if(res.length!=0)
        {
          for(var i=0;i<res.length;i++){
            idarry.concat(res[i].id)
          }
          data.categories=idarry;
          self.setData({categories:idarry})
                ...
                self.setData({
                  ...
                  postsList: self.data.postsList.concat(response.data.map(function (item) {
                    ...
                    if (item.post_medium_image == null || item.post_medium_image == '') {
                      item.post_medium_image = "https://ozil.vip/images/html.jpg";
                    }
